// Lưới ô vuông và số thứ tự
const crosswordMatrix = [
    // 15 dòng y chang hình bạn chụp, mình tự dựng nhé!
    ["1", "2", "", "", "", "", "", "", "", "", "", "", "", "", ""],
    ["", "R", "", "", "", "", "", "", "", "", "", "", "", "", ""],
    ["", "E", "3", "", "", "", "", "", "", "", "", "", "", "", ""],
    ["", "U", "", "4", "", "", "", "", "", "", "", "", "", "", ""],
  ...
  const hints = {
    ...
    2: "Reunification Day – A special day when two parts of a country become one again.",
    ...
    7: "April 30th – The day when the Vietnam War ended.",
    8: "National Holiday – A day when many people get off work to celebrate something important.",
